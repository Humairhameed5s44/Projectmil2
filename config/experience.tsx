...
export const Experiences: {
  ...
  SCG: {
    ...
    subDetail:
      'A group of devs on youtube that teach every type of computer skills',
    ...
    roles: [
      <>
        ...
        <Link
          ...
          rel="noreferrer"
        >
          FreeCodeCamp has been instrumental in helping me develop my coding
          skills from the ground up Through its structured, project-based
          curriculum I learned foundational programming languages like HTML,
          CSS, and JavaScript, as well as more advanced topics like responsive
          web design, data structures, algorithms, and front-end libraries.
          FreeCodeCamp’s hands-on approach, combined with its supportive
          community and wealth of coding challenges, has allowed me to practice
          coding regularly and build real-world projects that showcase my
          progress. This platform has not only equipped me with technical skills
          but also given me the confidence to tackle complex coding problems and
          continue advancing in software development.
        </Link>{' '}
        using NextJS and Typescript
      </>,
      <>
        Created multiple failed but helpful project which helped me to improve
        my programming skills.
      </>,
      <>
        I am currently working on mystery message web application by the help of
        this course
        <Link
          variant="nextjs"
      ...
      <>
        Make a website for my school so I could have class work in the exam but
        I lost motivation to do this but this has given me some motivation to do
        it my schools
        <Link
  ...
  Blotocol: {
    ...
    subDetail:
      'they provide corses in hindi and the person that run code aur has worked with freecodecamp on several occasions.',
    ...
    roles: [
      ...
      <>
        In 2020 I got my trusty laptop and since then I wanted to learn about it
        for the longest of time
      </>,
      <>
        I dont know I decided to learn all this but I happy I only know the
        basics of the majority but I am only 16
      </>,
